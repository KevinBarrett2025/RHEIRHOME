...
## In Progress
- Continue release hardening by expanding deterministic UI smoke coverage in `RHEIRUITests` beyond shell coverage, with saved receipt detail navigation/metadata now covered and the next selected-project receipt seam queued around receipt-detail edit/delete affordances after a successful manual save.
