...
## Next Milestone
- Prove relaunch persistence and same-device contractor workflows end-to-end on the simplified shell, then run the real-device acceptance pass for sign-in, first scan, and receipt return/reopen before treating same-user iCloud sync as a launch promise.
