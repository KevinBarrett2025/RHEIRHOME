...
struct PersonalSettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                // Tier Management Section (Fix interaction by using sheet presentation)
                Section {
                    Button {
                ...
                Section {
                    ...
                    Button("Clear UserDefaults") {
                        for key in UserDefaults.standard.dictionaryRepresentation().keys {
                            if key.hasPrefix("dev_") || key.hasPrefix("debug_") {
                    ...
                    Text("Development and testing tools. Not visible in production builds.")
                }
                #endif
            }
