...
struct ReceiptsView: View {
    ...
    @State private var selectedReceiptForImageView: Receipt?
    @State private var showingReceiptImageViewer = false
    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showingReceiptImageViewer) {
                if let receipt = selectedReceiptForImageView,
                   let receiptImage = receipt.receiptImage {
                    NavigationStack {
                        ScrollView {
                            VStack(spacing: 16) {
                        ...
                        .toolbar {
                            ToolbarItem(placement: .navigationBarTrailing) {
                                Button("Done") {
                                    showingReceiptImageViewer = false
                                }
                            }
                        }
                    }
