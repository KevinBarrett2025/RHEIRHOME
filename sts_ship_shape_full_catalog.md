...
- `RHEIRUITests` is now deterministic for signed-out, ready-state, organization-selection, project-selection, labor, company-admin, receipts-entry, manual-entry vendor-picker, manual-entry add-vendor, manual-entry payment-method-picker, manual-entry add-payment-method, manual-entry submission, and saved receipt detail coverage; the next release-hardening slice is receipt-detail edit/delete affordance coverage before broader runtime QA.
