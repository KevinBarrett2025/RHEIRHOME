...
## Open Work
- Use the new global project mutation/refresh contract while hardening Labor, Tasks, Reports, and remaining UI cleanup so those flows inherit immediate refresh instead of adding one-off state writes.
...
- Business Resources hub entry is simulator-proven; verify add/edit workers, vendors, and payment methods on device while hardening Labor.
